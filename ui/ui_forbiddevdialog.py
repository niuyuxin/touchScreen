...
class Ui_ForbidDevDialog(object):
    def setupUi(self, ForbidDevDialog):
        ...
        self.forbidDevExitPushButton.setMaximumSize(QtCore.QSize(200, 16777215))
        self.forbidDevExitPushButton.setDefault(True)
        self.forbidDevExitPushButton.setObjectName("forbidDevExitPushButton")
        self.horizontalLayout_2.addWidget(self.forbidDevExitPushButton)
    ...
    def retranslateUi(self, ForbidDevDialog):
        ...
        self.forbidDevExitPushButton.setText(_translate("ForbidDevDialog", "退出"))

...
class Ui_SettingDevDialog(object):
    def setupUi(self, SettingDevDialog):
        ...
        self.previousPushButton = QtWidgets.QPushButton(self.frame)
    ...
    def retranslateUi(self, SettingDevDialog):
        ...
        self.label_2.setText(_translate("SettingDevDialog", "旁路设定\n"
"当前只允许选中单个设备,“ok”选择生效 “cancel”放弃选择"))
        self.previousPushButton.setText(_translate("SettingDevDialog", "上一页"))
